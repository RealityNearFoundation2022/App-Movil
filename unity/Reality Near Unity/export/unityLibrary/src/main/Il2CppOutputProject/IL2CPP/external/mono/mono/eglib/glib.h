...
#if defined(G_OS_WIN32) && defined(RUNTIME_IL2CPP)
#include <io.h> // required for _read or _write
#endif
...
#if !defined(G_OS_WIN32) && (defined(G_HAVE_UNISTD_H) || defined(RUNTIME_IL2CPP))
#include <unistd.h>
#endif
